using Portfolio.TextRedactor;
using System;
using System.Drawing;
using System.IO;
using System.Windows.Forms;

namespace Porfolio.TextRedactor
{
    public partial class RedactorForm : Form
    {
        public RedactorForm()
        {
            ...
            if (!File.Exists("LinOnLastFile.txt")) Archive_Button.Enabled = false;
        }
        Font font;
        /// <summary>
        /// Кнопка открыть файл
        ...
        {
            if (File.Exists("LinOnLastFile.txt"))
            {
            ...
            else File.Create("LinOnLastFile.txt");
        }
        /// <summary>
